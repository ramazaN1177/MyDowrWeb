...
const AllList = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FFF8E1' }}>
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-5 shadow-xl" style={{ backgroundColor: '#FFB300' }}>
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="px-6 mt-5">
        <div className="bg-white rounded-xl p-3 shadow-lg flex items-center border-2" style={{ borderColor: '#FFB300' }}>
